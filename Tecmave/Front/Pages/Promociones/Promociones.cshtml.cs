...
namespace Front.Pages.Promociones
{
    ...
    public class PromocionesPageModel : PageModel
    {
        ...
        public async Task OnGetAsync()
        {
            ...
            Promociones = await client.GetFromJsonAsync<List<ApiProm.PromocionesModel>>(
        ...
        public async Task<IActionResult> OnPostEnviarAsync(int idUsuario)
        {
            ...
            TempData["Mensaje"] = response.IsSuccessStatusCode
                ? "Las promociones fueron enviadas correctamente."
                : "Se dio un error al enviar las promociones";
