...
CREATE TABLE `agendamiento` (
  ...
  KEY `vehiculo_agendamiento_idx` (`vehiculo_id`),
  KEY `fk_agendamientos_cliente` (`cliente_id`),
  CONSTRAINT `fk_agendamientos_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `aspnetusers` (`Id`),
  CONSTRAINT `vehiculo_agendamiento` FOREIGN KEY (`vehiculo_id`) REFERENCES `vehiculos` (`id_vehiculo`)
...
CREATE TABLE `detalle_factura` (
  ...
  KEY `facturaid_detalle_idx` (`factura_id`),
  KEY `servicioid_detalle_idx` (`servicio_id`),
  CONSTRAINT `facturaid_detalle` FOREIGN KEY (`factura_id`) REFERENCES `factura` (`id_factura`),
  CONSTRAINT `servicioid_detalle` FOREIGN KEY (`servicio_id`) REFERENCES `servicios` (`id_servicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `factura` (
  ...
  CONSTRAINT `fk_facturas_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `aspnetusers` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `resenas` (
  ...
  KEY `servicio_resena_idx` (`servicio_id`),
  KEY `fk_resenas_cliente` (`cliente_id`),
  CONSTRAINT `fk_resenas_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `aspnetusers` (`Id`),
  CONSTRAINT `servicio_resena` FOREIGN KEY (`servicio_id`) REFERENCES `servicios` (`id_servicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `servicios` (
  ...
  CONSTRAINT `tipo_servicio` FOREIGN KEY (`tipo_servicio_id`) REFERENCES `tipo_servicios` (`id_tipo_servicio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `servicios_revision` (
  `id_servicio_revision` int NOT NULL,
  ...
  KEY `revicion_id_idx` (`revision_id`),
  CONSTRAINT `revicion_id` FOREIGN KEY (`revision_id`) REFERENCES `revision` (`id_revision`),
...
-- Dump completed on 2025-09-17 22:48:18
